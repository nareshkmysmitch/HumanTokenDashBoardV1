...
fun TopAppBar(
    ...
    TopAppBar(
        title = {
            Text(
                text = title, fontWeight = FontWeight.Bold, color = AppColors.PurpleTitle
            )
        }, actions = {
            if (isChatVisible) {
            ...
            navigationIconContentColor = AppColors.PurpleTitle,
            titleContentColor = AppColors.PurpleTitle,
            actionIconContentColor = AppColors.PurpleTitle
        ), modifier = modifier
    )
}